...
var Router =
{
  ...
  {
console.log(['pn', player]);
    this.all.emit('player:new', player);
  },
  'player:answer': function(answer)
  {
console.log(['pa', answer]);
    this.all.in('audience').emit('player:answer', answer, function(result)
    {
      console.log(['player:answer', 'callback', result, answer]);
    });
  },
  //
  // admin commands
