...
//
// ### function replace (value, callback)
// #### @value {literal|Object} Value to replace with
// #### @callback {function} **Optional** Continuation to respond to when complete.
// Replaces the root of the storage with the specified `value`.
//
Provider.prototype.replace = function (value, callback) {
  return this._execute('replace', 1, value, callback);
};
...
// #### @value {literal|Object} Value to replace with
// #### @callback {function} **Optional** Continuation to respond to when complete.
// Pushes `value` to teh storage.
//
Provider.prototype.push = function (value, callback) {
  return this._execute('push', 1, value, callback);
};
